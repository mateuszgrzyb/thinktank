    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.PrivRoom')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='priv_chats',
            field=models.ManyToManyField(through='user.PrivRoom', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
